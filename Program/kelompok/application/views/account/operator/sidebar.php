				...
				<div class="sidebar-content">
					<div class="user">
						<div class="avatar-sm float-left mr-2">
							<img src="<?= base_url('assets'); ?>/img/21120115130090.jpg" alt="VLA" class="avatar-img rounded-circle">
						</div>
						<div class="info">
					...
					<ul class="nav nav-primary">
						<li class="nav-item <?php if($view_name=='account/operator/dashboard'){echo 'active';}?>">
